...
datasets = ['20ng', 'R8', 'R52', 'ohsumed', 'mr', 'implicit']
# build corpus
dataset = sys.argv[1]
...
f = open('data/' + dataset + '.train.index', 'w', encoding='utf-8') # shuffle之后的
...
f = open('data/' + dataset + '.test.index', 'w', encoding='utf-8')# shuffle之后的
...
f = open('data/corpus/' + dataset + '_word_vectors.txt', 'w', encoding='utf-8')
f.write(string)
f.close()
...
# slect 90% training set 10% validation
