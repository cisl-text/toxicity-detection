...
parser.add_argument('--bert_init', type=str, default='GroNLP/hateBERT',
                    choices=['roberta-base', 'roberta-large', 'bert-base-uncased', 'bert-large-uncased','GroNLP/hateBERT'])
parser.add_argument('--pretrained_bert_ckpt', default=r"checkpoint/GroNLP/hateBERT_implicit/checkpoint.pth")
parser.add_argument('--dataset', default='implicit', choices=['20ng', 'R8', 'R52', 'ohsumed', 'mr', 'implicit'])
...
metrics={
    ...
    'cls_report': ClassificationReport(output_dict=True),
}
...
def log_training_results(trainer):
    ...
    test_report = metrics['cls_report']
    print(test_report)
    logger.info(
